...
export class ManageTestService {
  ...
  constructor() {
    ...
    this.questionsArray.push(new Question(11, "Documents, Movies, Images and Photographs etc are stored at a ?", ["Application Sever", "Web Sever", "Print Server", "File Server"], "File Server"));
    this.questionsArray.push(new Question(12, "Which of following is used in RAM ?", ["Conductor", "Semi Conductor", "Vaccum Tubes", "Transistor"], "Semi Conductor"));
    this.questionsArray.push(new Question(13, "What is full form of GUI in terms of computers ?", ["Graphical user Instrument", "Graphical unified Interface", "Graphical unified Instrument", "Graphical user Interface"], "Graphical user Interface"));
    this.questionsArray.push(new Question(14, "What is full form of ALU ?", ["Arithmetic logic unit", "Allowed logic unit", "Ascii logic unit", "Arithmetic least unit"], "Arithmetic logic unit"));
    this.questionsArray.push(new Question(15, "Where are saved files stored in computer ?", ["RAM", "Hard disk", "Cache", "Any of above"], "Hard disk"));
